                ...
                <div class="card-body ">
                  <form method="get" action="/" class="form-horizontal">
                     ...
                     <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="Ingrese nombre y apellido" value="Alejandro Tidele">
                        </div>
                      </div>
                    </div>
                     <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="Ingrese fecha de nacimiento" value="12/08/1995">
                        </div>
                      </div>
                    </div>
                     <div class="row">
                     ...
                     <div class="row">
                      ...
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="Ingrese el e-mail" value="aleetidele@gmail.com">
                        </div>
                      </div>
                    </div>
                     <div class="row">
